...
var fileDescriptor_f3a0163ec53b86cf = []byte{
	...
	0x63, 0xf5, 0x42, 0x60, 0xc6, 0x06, 0xc1, 0xd5, 0x1a, 0xcd, 0x62, 0xe4, 0xe2, 0x80, 0x99, 0x24,
	0xe4, 0xc4, 0xc5, 0xed, 0x9e, 0x5a, 0x02, 0xe7, 0x4a, 0xe8, 0xc1, 0x9d, 0x8c, 0x6a, 0xbd, 0x94,
	0x38, 0xa6, 0x0c, 0xd8, 0x19, 0x4a, 0x0c, 0x42, 0x5e, 0x5c, 0x82, 0x48, 0x66, 0x04, 0x97, 0x14,
	0xa5, 0x26, 0xe6, 0x92, 0x65, 0x92, 0x01, 0x63, 0x12, 0x1b, 0xd8, 0xe9, 0xc6, 0x80, 0x00, 0x00,
	0x00, 0xff, 0xff, 0x7b, 0x23, 0x6d, 0x89, 0x3b, 0x01, 0x00, 0x00,
}
...
type DatetimeClient interface {
	...
	GetDatetimeStream(ctx context.Context, in *DatetimeParams, opts ...grpc.CallOption) (Datetime_GetDatetimeStreamClient, error)
}
...
func (c *datetimeClient) GetDatetimeStream(ctx context.Context, in *DatetimeParams, opts ...grpc.CallOption) (Datetime_GetDatetimeStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Datetime_serviceDesc.Streams[0], "/datetime.Datetime/GetDatetimeStream", opts...)
	if err != nil {
		return nil, err
	}
	x := &datetimeGetDatetimeStreamClient{stream}
...
type Datetime_GetDatetimeStreamClient interface {
	Recv() (*DatetimeReply, error)
	grpc.ClientStream
}

type datetimeGetDatetimeStreamClient struct {
	grpc.ClientStream
}

func (x *datetimeGetDatetimeStreamClient) Recv() (*DatetimeReply, error) {
	m := new(DatetimeReply)
...
type DatetimeServer interface {
	...
	GetDatetimeStream(*DatetimeParams, Datetime_GetDatetimeStreamServer) error
}
...
func (*UnimplementedDatetimeServer) GetDatetimeStream(req *DatetimeParams, srv Datetime_GetDatetimeStreamServer) error {
	return status.Errorf(codes.Unimplemented, "method GetDatetimeStream not implemented")
}
...
func _Datetime_GetDatetimeStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(DatetimeParams)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(DatetimeServer).GetDatetimeStream(m, &datetimeGetDatetimeStreamServer{stream})
}

type Datetime_GetDatetimeStreamServer interface {
	Send(*DatetimeReply) error
	grpc.ServerStream
}

type datetimeGetDatetimeStreamServer struct {
	grpc.ServerStream
}

func (x *datetimeGetDatetimeStreamServer) Send(m *DatetimeReply) error {
...
var _Datetime_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		{
			StreamName:    "GetDatetimeStream",
			Handler:       _Datetime_GetDatetimeStream_Handler,
			ServerStreams: true,
		},
	},
